...
TxProposal.create = function(opts) {
  ...
  if (x.outputs[0] != null && (x.outputs[0].toAddress != null || x.outputs[0].amount != 0 || x.outputs[0].script == null)) {
    try {
...
TxProposal.prototype._buildTx = function() {
  ...
  // MODIFIED - totalOutputs of 0 is ok
  $.checkState(totalInputs > 0 && totalInputs >= totalOutputs);
